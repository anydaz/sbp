...
class ProductsImport implements ToModel, WithBatchInserts, WithUpserts, withHeadingRow, WithValidation, SkipsOnFailure
{
    /**
    * @param array $row
    *
    ...
    */
    ...
    public function model(array $row)
    {
        ...
        return new Product([
            ...
            'plus'          => $row['plus'] ?? null,
            'quantity'      =>  $quantity,
            'cogs'           => $quantity > 0 ? $row['harga_jual'] - ($row['harga_jual'] * 0.3) : 0,
